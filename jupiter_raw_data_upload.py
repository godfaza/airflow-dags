...
with DAG(
    ...
    copy_data_db_to_hdfs(schema_query,parameters["MaintenancePath"],"EXTRACT_ENTITIES_AUTO.csv")
    generate_upload_scripts(parameters["MaintenancePath"],"EXTRACT_ENTITIES_AUTO.csv")                                                      
